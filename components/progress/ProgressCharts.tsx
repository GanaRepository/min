...
export default function ProgressCharts({ weeklyActivity, className }: ProgressChartsProps) {
    ...
    >
     ...
     <div className="mt-6 grid grid-cols-2 md:grid-cols-4 gap-4">
       {[
         ...
         { 
           label: 'Avg Per Day', 
           value: Math.round(chartData.reduce((sum, day) => sum + day.words, 0) / chartData.length),
           color: 'text-blue-400'
         },
         { 
           label: 'Best Day', 
