...
import { ChevronDown, ChevronUp, Download, AlertCircle, CheckCircle, XCircle } from 'lucide-react';
...
const Comprehensive42FactorAssessment: React.FC<Props> = ({ assessment, storyId, storyTitle }) => {
  ...
  const StatusIcon = ({ status }: { status: string }) => {
    ...
    if (status === 'Flagged') return <XCircle className="h-5 w-5 text-red-600" />;
  ...
  const factorSections = [
    {
      ...
      factors: [
        ...
        { key: 'vocabularyRange', name: '2. Vocabulary Range & Appropriateness' },
    ...
    },
    {
      ...
      factors: [
        ...
        { key: 'characterDevelopment', name: '8. Character Development & Consistency' },
        { key: 'settingWorldBuilding', name: '9. Setting & World-building' },
        { key: 'dialogueQuality', name: '10. Dialogue Quality' },
        { key: 'themeRecognition', name: '11. Theme Recognition & Development' },
    ...
    },
    {
      ...
      factors: [
        ...
        { key: 'imageryDescriptiveWriting', name: '14. Imagery & Descriptive Writing' },
        { key: 'sensoryDetailsUsage', name: '15. Sensory Details Usage' },
        { key: 'metaphorFigurativeLanguage', name: '16. Metaphor & Figurative Language' },
    ...
    },
    {
      ...
      factors: [
        ...
        { key: 'transitionsBetweenIdeas', name: '21. Transitions Between Ideas' },
        { key: 'openingClosingEffectiveness', name: '22. Opening & Closing Effectiveness' },
    ...
    },
    {
      ...
      factors: [
        ...
        { key: 'pointOfViewConsistency', name: '26. Point of View Consistency' },
        { key: 'moodAtmosphereCreation', name: '27. Mood & Atmosphere Creation' },
        { key: 'culturalSensitivity', name: '28. Cultural Sensitivity & Awareness' },
      ]
    },
    {
      id: 'ai-detection',
      ...
      factors: [
        ...
        { key: 'ageAppropriateLanguage', name: '31. Age-Appropriate Language Use' },
        { key: 'personalVoiceRecognition', name: '32. Personal Voice Recognition' },
      ]
    },
    {
      ...
      factors: [
        { key: 'strengthsIdentification', name: '33. Strengths Identification' },
        ...
        { key: 'teachersHolisticAssessment', name: '37. Teacher\'s Holistic Assessment' },
        { key: 'personalizedLearningPath', name: '38. Personalized Learning Path' },
        { key: 'practiceExerciseRecommendations', name: '39. Practice Exercise Recommendations' },
        { key: 'genreExplorationSuggestions', name: '40. Genre Exploration Suggestions' },
        { key: 'vocabularyBuildingExercises', name: '41. Vocabulary Building Exercises' },
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 bg-gray-50 min-h-screen">
      <div className="mb-6">
        <h1 className="text-3xl font-bold text-gray-900 mb-2">Comprehensive 42-Factor Assessment</h1>
      ...
      <div className="mb-6">
        ...
        {expandedSections.has('overview') && (
          <div className="mt-4 space-y-4">
            <div className={`p-6 rounded-lg border-2 ${getScoreBgColor(assessment.overallScore)}`}>
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-3">
                  <StatusIcon status={assessment.status} />
                  <span className="text-2xl font-bold text-gray-900">Overall Score</span>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <p className={`font-bold text-lg ${
                      assessment.aiDetectionResult.result === 'Human-written' ? 'text-green-600' : 'text-red-600'
                    }`}>
                  ...
                  <div>
                    ...
                    <p className="font-bold text-lg text-gray-900">
                      {Math.round(assessment.aiDetectionResult.confidenceLevel * 100)}%
                    </p>
                  </div>
                </div>
                <p className="mt-3 text-gray-700 text-sm">{assessment.aiDetectionResult.analysis}</p>
              </div>
            )}
          </div>
        )}
          ...
          {expandedSections.has(section.id) && (
            <div className="mt-4 space-y-3">
              {section.factors.map((factor) => {
                const factorData = assessment.allFactors[factor.key as keyof typeof assessment.allFactors];
