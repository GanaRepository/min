  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute -top-4 -right-4 w-24 h-24 bg-emerald-500/10  blur-xl"></div>
        <div className="absolute -bottom-8 -left-8 w-32 h-32 bg-teal-500/10  blur-2xl"></div>
      </div>
      ...
      <div className="container mx-auto px-3 sm:px-6 relative z-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 sm:gap-10 md:gap-12 mb-8 sm:mb-10">
          ...
          <div className="md:col-span-1 mb-8 sm:mb-12">
            ...
            <div>
              <h3 className="text-sm sm:text-base  mb-3 sm:mb-4 relative pl-3 before:content-[''] before:absolute before:left-0 before:top-0 before:h-full before:w-1 before:bg-emerald-500">
                Connect With Us
              </h3>
          ...
          <div className="md:col-span-1 md:pl-6 lg:pl-12">
            <h3 className="text-sm sm:text-base  mb-4 sm:mb-6 relative pl-3 before:content-[''] before:absolute before:left-0 before:top-0 before:h-full before:w-1 before:bg-emerald-500">
              Quick Links
            </h3>
          ...
          <div className="md:col-span-2">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
              {/* USA Office Card */}
              <div className="bg-white/10 backdrop-blur-sm overflow-hidden shadow-md relative border border-emerald-200/20  min-h-[260px] sm:min-h-[240px]">
                <div className="absolute top-0 right-0 bg-blue-600 text-white rounded-bl-lg px-2 py-1 text-xs  z-10">
                  US
                </div>
                <div className="h-24 sm:h-40 relative bg-gradient-to-br from-teal-400/80 to-cyan-500/80 flex items-center justify-center">
                  <div className="text-white text-2xl sm:text-4xl  opacity-20">
                    🇺🇸
                  </div>
                </div>
                <div className="p-3 sm:p-4">
                  <p className=" text-xs sm:text-sm mb-2 sm:mb-4 text-center text-emerald-300">
                    USA Office
                  </p>
              ...
              {/* India Office Card */}
              <div className="bg-white/10 backdrop-blur-sm overflow-hidden shadow-md relative border border-emerald-200/20  min-h-[260px] sm:min-h-[240px]">
                <div className="absolute top-0 right-0 bg-orange-600 text-white rounded-bl-lg px-2 py-1 text-xs  z-10">
                  IN
                </div>
