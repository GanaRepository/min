...
export default function DigitalCertificate({ winnerData, onDownload }: CertificateProps) {
  ...
  const getPositionIcon = () => {
    switch (winnerData.position) {
      case 1: return <Trophy className="w-16 h-16 text-yellow-500" />;
      case 2: return <Medal className="w-16 h-16 text-gray-400" />;
      case 3: return <Medal className="w-16 h-16 text-amber-600" />;
      default: return <Star className="w-16 h-16 text-purple-500" />;
    }
  };
  ...
  const getPositionText = () => {
    switch (winnerData.position) {
      ...
      default: return "Competition Winner";
    }
  };
    ...
    <div className="flex flex-col items-center gap-4">
      ...
      >
        ...
        <div className="text-center px-12">
          ...
          <h2 className="text-5xl font-bold text-gray-800 mb-6" style={{ fontFamily: 'serif' }}>
          ...
          <p className="text-lg text-gray-600 mb-2">
            for the story "<span className="font-semibold text-gray-800">{winnerData.title}</span>"
          </p>
          
          <p className="text-lg text-gray-600">
            with a score of <span className="font-bold text-green-600">{winnerData.score}%</span>
          </p>
        </div>
