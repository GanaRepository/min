...
export default function WritingTips({ turnNumber, elements, className }: WritingTipsProps) {
 const tips = writingTips[turnNumber as keyof typeof writingTips] || writingTips[6];
