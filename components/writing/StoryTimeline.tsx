// // // components/writing/StoryTimeline.tsx (UPDATED)
// // 'use client';
...
// //   turns: Turn[];
// //   currentTurn: number;
// //   aiOpening?: string; // ✅ Add AI opening prop
...
// //             className="space-y-3"
// //           >
// //             {/* Show what child "input" (selected elements) */}
...
// //                     {storyElements && Object.entries(storyElements).map(([type, value]) => (
// //                       <span
// //                         key={type}
...
// //         {/* Regular Story Turns (Turn 1+) */}
// //         {turns.length === 0 && !aiOpening ? (
// //           <div className="text-gray-400 text-center py-8">
// //             <Bot className="w-12 h-12 mx-auto mb-3 opacity-50" />
// //             <p>Your story will appear here as you write!</p>
// //           </div>
// //         ) : (
...
// // components/writing/StoryTimeline.tsx (FIXED CHAT FORMAT)
// 'use client';
...
//         {/* ✅ 2. AI: Opening Response (RIGHT SIDE) */}
//         {aiOpening && (
//           <motion.div
//             initial={{ opacity: 0, y: 20 }}
//             animate={{ opacity: 1, y: 0 }}
