      ...
      <CardContent className="space-y-6">
        ...
        <div className="space-y-2">
          <div className="flex justify-between items-center">
            <span className="text-sm  text-gray-300">Freestyle Stories</span>
        ...
        <div className="space-y-2">
          <div className="flex justify-between items-center">
            <span className="text-sm  text-gray-300">AI Assessments</span>
            <span className="text-sm  text-gray-200">
        ...
        <div className="space-y-2">
          <div className="flex justify-between items-center">
            <span className="text-sm  text-gray-300">Competition Entries</span>
            <span className="text-sm  text-gray-200">
        ...
        {!isStoryPackActive && onUpgrade && (
          <div className="mt-6 p-4 bg-purple-800/60 backdrop-blur-xl border border-purple-600/40 rounded-xl">
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                <h4 className=" text-purple-200 mb-1">Unlock More Stories</h4>
