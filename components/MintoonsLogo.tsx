...
const AdvancedMintoonsLogo: React.FC<AdvancedMintoonsLogoProps> = ({
  ...
  const sizes = {
    sm: {
      ...
      sparkle: 'w-2 h-2 sm:w-2.5 sm:h-2.5',
    },
    md: {
      ...
      sparkle: 'w-3 h-3 sm:w-3.5 sm:h-3.5 md:w-4 md:h-4',
    },
    lg: {
      ...
      sparkle: 'w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6',
    },
    xl: {
      ...
      sparkle: 'w-5 h-5 sm:w-6 sm:h-6 md:w-7 md:h-7',
    },
  };
