  ...
  */
  ...
  export const sendStoryPackPurchaseConfirmation = async (
    ...
    try {
      ...
      console.error('Error sending Story Pack purchase confirmation emails:', error);
      throw error;
    }
  };
  ...
  export const sendAnthologyBookPurchaseConfirmation = async (
    ...
    const userMailOptions = {
      ...
      to: email,
      subject: '📚 Anthology Reservation Confirmed - You\'re Going to be Published!',
      html: `
        <div style="font-family: 'Segoe UI', -apple-system, BlinkMacSystemFont, sans-serif; max-width: 650px; margin: 0 auto; background: #ffffff; border-radius: 20px; overflow: hidden; box-shadow: 0 20px 60px rgba(0,0,0,0.1);">
          ${getEmailHeader()}
    ...
    try {
      ...
      console.log('Anthology book purchase confirmation emails sent successfully:', {
        userMessageId: userInfo.messageId,
        adminMessageId: adminInfo.messageId,
      });
      ...
      console.error('Error sending anthology book purchase confirmation emails:', error);
      throw error;
    }
  };
