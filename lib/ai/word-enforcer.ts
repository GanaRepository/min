...
export const TURN_PROGRESSION: TurnRequirement[] = [
  {
    ...
    minWords: 30,
    maxWords: 50,
    guidance: 'Start your adventure (4-5 lines)',
  },
  {
    turnNumber: 2,
    minWords: 40,
    maxWords: 70,
    guidance: 'Develop the story (5-7 lines)',
  },
  {
    turnNumber: 3,
    minWords: 50,
    maxWords: 80,
    guidance: 'Add more details (6-8 lines)',
  },
  {
    turnNumber: 4,
    minWords: 60,
    maxWords: 90,
    guidance: 'Build excitement (7-9 lines)',
  },
  {
    turnNumber: 5,
    minWords: 70,
    maxWords: 100,
    guidance: 'Create the climax (8-10 lines)',
  },
  {
    turnNumber: 6,
    minWords: 80,
    maxWords: 120,
    guidance: 'Write the ending (10-12 lines)',
  },
];
...
export function getTurnRequirement(turnNumber: number): TurnRequirement {
  return (
    TURN_PROGRESSION[turnNumber - 1] ||
    TURN_PROGRESSION[TURN_PROGRESSION.length - 1]
  );
}
