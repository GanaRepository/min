// // app/children-dashboard/story/[sessionId]/page.tsx - COMPLETE FIXED VERSION
// 'use client';
...
//     tone?: string;
//   };
//   storyMode?: 'guided' | 'freeform';  // ✅ ADDED: Story mode
//   currentTurn: number;
//   totalWords: number;
//   childWords: number;
//   apiCallsUsed: number;
...
//               .filter(([type, value]) => value && value.trim() !== '') // Only show non-empty elements
//               .map(([type, value]) => (
//                 <span
//                   key={type}
...
export default function StoryWritingPage({
  ...
  // Calculate maxTurns based on story mode
  const maxTurns = storySession?.storyMode === 'guided' ? 6 : 7;
