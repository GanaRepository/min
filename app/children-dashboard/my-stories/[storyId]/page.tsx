            ...
            <div className="bg-gray-800/60 backdrop-blur-xl border border-gray-600/40 rounded-xl p-6">
              ...
              <div className="space-y-4">
                {[
                  {
                    label: 'Grammar',
                    score: story.grammarScore,
                    color: 'green',
                  },
                  {
                    label: 'Creativity',
                    score: story.creativityScore,
                    color: 'blue',
                  },
                  {
                    label: 'Overall',
                    score: story.overallScore,
                    color: 'purple',
                  },
                ].map((item) => (
                  <div key={item.label}>
              ...
              <div className="space-y-4">
                <div className="border-l-4 border-green-500 pl-4">
                  ...
                  <p className="text-gray-300 text-sm">
                    "Great use of dialogue! Your characters feel real and
                    engaging."
                  </p>
                </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="text-center">
              ...
              <div className="text-gray-300 text-sm">
                Explore Mystery or Comedy for variety!
              </div>
            </div>
            <div className="text-center">
              ...
              <div className="text-gray-300 text-sm">
                Make characters talk more in your next story
              </div>
            </div>
            <div className="text-center">
              ...
              <div className="text-gray-300 text-sm">
                Use more sounds, smells, and textures
              </div>
            </div>
          </div>
        </motion.div>
