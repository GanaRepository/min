        ...
        <div className="space-y-8">
          ...
          {story.assessment && (
            ...
            >
              ...
              <div className="bg-gradient-to-r from-green-600/20 to-blue-600/20 border border-green-500/30 rounded-xl p-6 text-center">
                ...
                <div
                  className={`text-5xl font-bold mb-2 ${getScoreColor(story.assessment.overallScore)}`}
                >
                  {story.assessment.overallScore >= 90
                    ? '🌟'
                    : story.assessment.overallScore >= 80
                      ? '⭐'
                      : story.assessment.overallScore >= 70
                        ? '✨'
                        : '💫'}{' '}
                  {story.assessment.overallScore}%
                </div>
                <div className="text-gray-300 text-lg">
                  {story.assessment.readingLevel} Level
                </div>
              ...
              <div className="bg-gray-800/60 border border-gray-600/40 rounded-xl p-6">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                  {[
                    ...
                    {
                      label: 'Creativity',
                      score: story.assessment.creativityScore,
                    },
                    {
                      label: 'Vocabulary',
                      score: story.assessment.vocabularyScore,
                    },
                    {
                      label: 'Structure',
                      score: story.assessment.structureScore,
                    },
                    {
                      label: 'Characters',
                      score: story.assessment.characterDevelopmentScore,
                    },
                    {
                      label: 'Plot',
                      score: story.assessment.plotDevelopmentScore,
                    },
                  ].map((category, index) => (
                    <div
                      key={category.label}
                ...
                {story.assessment.improvements &&
                  story.assessment.improvements.length > 0 && (
                    <div className="bg-blue-600/20 border border-blue-500/30 rounded-xl p-6">
                      ...
                      <ul className="space-y-2">
                        {story.assessment.improvements.map(
                          (improvement, index) => (
                            <li
                              key={index}
          ...
          >
            ...
            {story.assessment && (
              <button
                onClick={() =>
                  router.push(`/children-dashboard/assessment/${story._id}`)
                }
