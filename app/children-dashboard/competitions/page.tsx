...
export default function CompetitionPage() {
 ...
 const getPhaseColor = (phase: string) => {
   switch (phase) {
     ...
     case 'results': return 'text-purple-400';
           ...
           <div className="bg-gradient-to-br from-purple-600/20 to-pink-600/20 border border-purple-500/30 rounded-xl p-8">
             ...
             <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
               <div className="text-center">
                 <div className={`text-2xl font-bold ${getPhaseColor(currentCompetition.phase)}`}>
             ...
             {session && currentCompetition.userStats && (
               <div className="bg-gray-800/50 rounded-lg p-6 mb-6">
                 ...
                 {currentCompetition.userEntries && currentCompetition.userEntries.length > 0 && (
                   <div className="space-y-3">
                     <h4 className="text-white font-medium">Your Submissions:</h4>
                     {currentCompetition.userEntries.map((entry, index) => (
                       <div key={entry.storyId} className="flex items-center justify-between bg-gray-700/50 rounded-lg p-3">
                         <div>
             ...
             {currentCompetition.phase === 'judging' && (
               <div className="bg-blue-600/20 border border-blue-500/30 rounded-lg p-6 text-center">
                 ...
                 <div className="text-blue-200">
                   Our advanced AI is carefully reviewing all {currentCompetition.totalSubmissions} submissions. 
               ...
               >
                 <div className="flex items-center justify-between mb-4">
                   ...
                   <div className={`px-2 py-1 rounded text-xs font-medium ${
                     ...
                     {competition.phase === 'results' ? 'Completed' : competition.phase}
                   </div>
                 </div>
         ...
         <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
           ...
           >
             <div className="flex items-center justify-between mb-6">
               <h3 className="text-xl font-bold text-white">Submit to Competition</h3>
               <button
             ...
             {eligibleStories.length === 0 ? (
               <div className="text-center py-8">
                 ...
                 <h4 className="text-white font-medium mb-2">No Eligible Stories</h4>
                 <p className="text-gray-400 mb-4">
                   You need published stories to enter competitions. Publish a story for $10 to make it eligible.
                 </p>
                 <Link
               ...
               <div className="space-y-4">
                 <p className="text-gray-300 mb-4">
                   Select a published story to submit to the {currentCompetition?.month} competition:
                 </p>
                     ...
                     <div className="flex items-center justify-between">
                       <div>
                         ...
                         <div className="text-gray-400 text-sm mt-1">
                           ...
                           {story.assessment && (
                             <span className="ml-2">• Score: {story.assessment.overallScore}%</span>
                           )}
                         </div>
                       </div>
                       <button
