        ...
        >
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              ...
              and
              <span className="text-purple-400 "> amazing recognition</span> for
              winners!
            </p>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-400 text-sm">
                Top 3 winners announced with digital certificates and community
                recognition!
              </p>
            </div>
          </div>
            ...
            >
              ...
              <div className="mb-8">
                ...
                <p className="text-md text-gray-600">
                  Score:{' '}
                  <span className="">{certificateData.score.toFixed(1)}%</span>
                </p>
              </div>
