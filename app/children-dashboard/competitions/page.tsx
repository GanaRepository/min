    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 to-blue-50 p-6">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex items-center gap-4 mb-6">
          <Link href="/children-dashboard" className="text-gray-600 hover:text-gray-800">
            <ArrowLeft size={24} />
          </Link>
          <div>
            <h1 className="text-3xl font-bold text-gray-900">Writing Competitions</h1>
            <p className="text-gray-600">Showcase your stories and compete with young writers worldwide!</p>
          </div>
        </div>

        {/* Current Competition */}
        {currentCompetition && (
          <div className="bg-gradient-to-r from-purple-600 to-blue-600 rounded-xl p-6 text-white mb-6 shadow-xl">
                ...
                {eligibleStories.length > 0 ? (
                  <div className="grid gap-3">
                    {eligibleStories.map((story) => (
                      <div key={story._id} className="flex items-center justify-between bg-white/20 rounded-lg p-3">
                        <div className="flex-1">
              ...
              <div className="bg-white/10 rounded-lg p-4 mt-4">
                ...
                <div className="space-y-2">
                  {currentCompetition.userStats.userEntries.map((entry) => (
                    <div key={entry.storyId} className="flex items-center justify-between bg-white/20 rounded-lg p-3">
                      <div>
              ...
              <div className="bg-white/10 rounded-lg p-4 mt-4">
                ...
                <div className="space-y-3">
                  {currentCompetition.winners.map((winner) => (
                    <div key={winner.position} className="flex items-center gap-3 bg-white/20 rounded-lg p-3">
        ...
        <div className="bg-white rounded-xl shadow-sm border p-6">
          ...
          {pastCompetitions.length > 0 ? (
            ...
            <div className="text-center py-8">
              ...
              <p className="text-gray-500">No past competitions found</p>
            </div>
          )}
        </div>
      </div>
