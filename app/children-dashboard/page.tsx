...
export default function ChildrenDashboard() {
  ...
  const { overview, monthly, sessions, achievements, weeklyProgress } = dashboardData;
          ...
          >
            <div>
              ...
              <p className="text-gray-300 mt-2 text-lg">
                {overview.isActiveToday ? "You're on a writing streak!" : "Ready to write your next amazing story?"}
              </p>
              ...
              {subscriptionInfo && (
                <div className="mt-3 flex items-center space-x-4 text-sm">
                  ...
                  <span className="text-gray-400">
                    {subscriptionInfo.storiesRemaining} stories remaining this month
                  </span>
                </div>
              )}
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
              ...
              >
                <div className="flex items-center justify-between mb-4">
                  ...
                  <span className="text-blue-300 text-sm font-medium">Stories</span>
                </div>
                <div className="text-3xl font-bold text-white mb-1">{overview.totalStoriesCreated}</div>
              ...
              >
                <div className="flex items-center justify-between mb-4">
                  ...
                  <span className="text-green-300 text-sm font-medium">Words</span>
                </div>
              ...
              >
                ...
                <div className="text-3xl font-bold text-white mb-1">{overview.writingStreak}</div>
              ...
              <div className="space-y-4">
                {dashboardData.recentActivity.length > 0 ? (
                  dashboardData.recentActivity.slice(0, 5).map((activity: any) => (
                    <div key={activity.id} className="flex items-center justify-between p-4 bg-gray-700/30 rounded-xl">
                      <div className="flex items-center space-x-3">
                        <div className="w-10 h-10 bg-blue-500/20 rounded-lg flex items-center justify-center">
                          <PenTool className="w-5 h-5 text-blue-400" />
                        </div>
                        <div>
                          <div className="font-medium text-white">{activity.sessionTitle}</div>
                          <div className="text-sm text-gray-400">
                            Turn {activity.turnNumber} • {activity.wordCount} words
                          </div>
                        </div>
                      </div>
                  ...
                  <div className="text-center py-12 text-gray-400">
                    ...
                    <p className="text-lg">Start writing to see your activity here!</p>
                    <button
                      onClick={() => router.push('/create-stories')}
              ...
              {sessions.active > 0 ? (
                <div>
                  ...
                  <p className="text-gray-300 text-lg mb-6">
                    {sessions.active === 1 ? 'story waiting' : 'stories waiting'} for you to continue
                  </p>
                  <button
                    onClick={() => router.push('/children-dashboard/my-stories?filter=active')}
                ...
                <div className="text-center py-8">
                  <p className="text-gray-400 mb-6 text-lg">No stories in progress</p>
                  <button
                    onClick={() => router.push('/create-stories')}
              ...
              <div className="space-y-3">
                {achievements.slice(0, 5).map((achievement, index) => (
                  ...
                  >
                    ...
                    <span className="text-purple-200 font-medium">{achievement}</span>
                  </motion.div>
                ))}
