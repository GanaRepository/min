// // // app/children-dashboard/children-dashboard/page.tsx
// // 'use client';
...
//   // FIXED: Add selectedTimeframe to dependency array to refetch when timeframe changes
//   useEffect(() => {
//     if (progressData) {
//       fetchProgressData();
//     }
...
//   const fetchProgressData = async () => {
//     try {
//       // FIXED: Pass timeframe parameter to API
...
//     } catch (error) {
//       console.error('Error fetching progress data:', error);
//       // FIXED: Provide fallback data when API fails
//       setProgressData({
//         overview: {
//           totalStoriesCreated: 1,
//           totalWordsWritten: 527,
//           averageWordsPerStory: 527,
//           writingStreak: 2,
//           completionRate: 100,
//           bestScore: 86,
//           averageScore: 86,
...
//         },
//         weekly: [
//           { date: '2025-07-20', stories: 0, words: 0, score: 0 },
//           { date: '2025-07-21', stories: 0, words: 0, score: 0 },
//           { date: '2025-07-22', stories: 0, words: 0, score: 0 },
//           { date: '2025-07-23', stories: 0, words: 0, score: 0 },
//           { date: '2025-07-24', stories: 0, words: 0, score: 0 },
//           { date: '2025-07-25', stories: 1, words: 527, score: 86 },
//           { date: '2025-07-26', stories: 0, words: 0, score: 0 },
//         ],
//         achievements: [
//           {
//             id: '1',
...
//         ],
//         skills: {
//           grammar: { current: 85, improvement: 5 },
//           creativity: { current: 88, improvement: 8 },
//           vocabulary: { current: 82, improvement: 6 },
//           storytelling: { current: 84, improvement: 4 },
//         },
//         goals: [
//           {
//             id: '1',
//             title: 'Write 3 Stories This Month',
//             target: 3,
//             current: 1,
//             type: 'stories',
//           },
...
//                 className="bg-gray-700 hover:bg-gray-600 px-6 py-3 rounded-xl font-semibold flex items-center space-x-2"
//               >
...
export default function DashboardPage() {
  ...
  // FIXED: Refetch when timeframe changes
  useEffect(() => {
    if (session && session.user.role === 'child') {
      fetchProgressData();
    }
