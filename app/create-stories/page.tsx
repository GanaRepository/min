...
export default function CreateStoriesPage() {
  ...
  return (
    <div className=" py-10 text-white min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-green-900 relative overflow-hidden">
      ...
      {/* Final Call to Action - If user hasn't started selecting elements */}
      {!Object.values(selectedElements).some((value) => value !== '') && (
        <motion.div
        ...
        >
          <div className="max-w-4xl mx-auto text-center">
            <motion.div
              className="bg-gradient-to-r from-purple-500/20 to-pink-500/20 border border-purple-500/30 rounded-3xl p-12 backdrop-blur-xl"
            ...
            >
              ...
              <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
                ...
                stories with AI collaboration. Your imagination is the only
                limit!
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                <motion.button
                  ...
                  className="bg-gradient-to-r from-purple-500 to-pink-600 hover:from-purple-600 hover:to-pink-700 text-white px-8 py-4 rounded-xl font-semibold text-lg shadow-lg shadow-purple-500/25 flex items-center space-x-2"
                >
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mt-12 pt-8 border-t border-white/10">
                {[
                  { number: '10K+', label: 'Stories Created', icon: BookOpen },
                  { number: '500+', label: 'Happy Writers', icon: Heart },
                  {
                    number: '95%',
                    label: 'Improved Writing',
                    icon: TrendingUp,
                  },
