...
//         description:
//           'Please select all story elements before creating your story.',
//         variant: 'destructive',
//       });
//       return;
//     }
...
//           <h2 className="text-2xl  text-white mb-2">Creating Your Story...</h2>
...
//                 description:
//                   'Select guided story building with elements or write your own opening',
//                 icon: Compass,
//                 color: 'from-purple-500 to-indigo-600',
//               },
//               {
...
//                 description:
//                   'Our AI helps guide your story or responds to your creative writing',
//                 icon: Sparkles,
//                 color: 'from-blue-500 to-cyan-600',
//               },
//               {
...
//                 description:
//                   'Continue writing your story with AI assistance and bring it to life',
//                 icon: BookOpen,
...
//           >
//             <h2 className="text-4xl  text-white mb-4">Why Choose Mintoons?</h2>
...
//                 description:
//                   'Get creative help and story suggestions from our smart AI',
//                 color: 'from-purple-500 to-indigo-600',
//               },
//               {
//                 icon: Shield,
...
//                 description:
//                   'Safe, educational storytelling designed for young minds',
//                 color: 'from-green-500 to-teal-600',
//               },
//               {
//                 icon: TrendingUp,
...
//                 description:
//                   'Instant suggestions to improve your writing skills',
//                 color: 'from-blue-500 to-cyan-600',
//               },
//               {
//                 icon: Users,
...
//                 description:
//                   'Explore any genre, character, or setting you can imagine',
...
//                     <div
//                       className={`absolute inset-0 bg-gradient-to-r ${feature.color} rounded-lg blur-lg opacity-20 group-hover:opacity-30 transition-opacity`}
//                     ></div>
//                     <div
//                       className={`relative bg-gradient-to-r ${feature.color} w-12 h-12 rounded-lg flex items-center justify-center`}
//                     >
...
//                         }`}
//                         disabled={
//                           index > currentStep && !isCurrentStepComplete(index)
//                         }
//                       >
...
//                       {STORY_ELEMENTS[
//                         steps[currentStep]?.id as keyof typeof STORY_ELEMENTS
...
//                               selectedElements[steps[currentStep]?.id] ===
//                               element.name
...
//                         </div>
//                         <div
//                           className={`text-white font-medium ${!value ? 'text-gray-500' : ''}`}
//                         >
//                           {value || 'Not selected'}
//                         </div>
//                       </div>
...
//                   {Object.values(selectedElements).every(
//                     (value) => value !== ''
//                   ) && (
//                     <motion.div
...
//                         Your {selectedElements.mood} {selectedElements.genre}{' '}
//                         adventure featuring {selectedElements.character} in{' '}
//                         {selectedElements.setting} awaits!
//                       </div>
//                     </motion.div>
//                   )}
...
//                   <motion.button
//                     whileHover={{
//                       scale: Object.values(selectedElements).every(
//                         (value) => value !== ''
//                       )
//                         ? 1.02
//                         : 1,
...
// app/create-stories/page.tsx - Selection page for Write New vs Upload Assessment
'use client';

import { useState, useEffect } from 'react';
import { useSession } from 'next-auth/react';
import { useRouter } from 'next/navigation';
import { Upload, PenTool, FileText, AlertCircle, Zap } from 'lucide-react';
...
export default function CreateStoriesPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-green-900 py-8 mt-20">
      <div className="max-w-4xl mx-auto px-4">
        {/* Header */}
        <div className="text-center mb-8 pt-16">
          <h1 className="text-3xl font-medium text-white mb-2">Create Your Story</h1>
          <p className="text-gray-300">Choose how you'd like to work on your story today</p>
        </div>
        ...
        {usage && limits && (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
            ...
            <div className="bg-white p-4 border border-gray-200 text-center">
              <p className="text-sm text-gray-600">Assessment Uploads</p>
              <p className="text-2xl font-medium text-gray-900">
            ...
            <div className="bg-white p-4 border border-gray-200 text-center">
              <p className="text-sm text-gray-600">Competition Entries</p>
              <p className="text-2xl font-medium text-gray-900">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <Card className="border-2 hover:border-blue-300 transition-colors cursor-pointer h-full">
              <CardHeader className="text-center pb-4">
                <div className="w-16 h-16 bg-blue-100 text-blue-600 flex items-center justify-center mx-auto mb-4 border border-blue-200">
                  <PenTool className="w-8 h-8" />
                </div>
                <CardTitle className="text-xl font-medium text-gray-900">Write New Story</CardTitle>
            ...
            <Card className="border-2 hover:border-green-300 transition-colors cursor-pointer h-full">
              <CardHeader className="text-center pb-4">
                <div className="w-16 h-16 bg-green-100 text-green-600 flex items-center justify-center mx-auto mb-4 border border-green-200">
                  <Upload className="w-8 h-8" />
                </div>
                <CardTitle className="text-xl font-medium text-gray-900">Upload for Assessment</CardTitle>
                <CardDescription className="text-gray-600">
        ...
        {mode === 'write' && (
          <Card className="max-w-2xl mx-auto">
            <CardHeader>
              <CardTitle className="text-center">Ready to Start Writing?</CardTitle>
        ...
        {mode === 'upload' && (
          <Card className="max-w-2xl mx-auto">
            <CardHeader>
              <CardTitle>Upload Your Story for Assessment</CardTitle>
              <CardDescription>
            ...
            <CardContent className="space-y-6">
              ...
              {/* File Upload */}
              <div className="space-y-2">
                <Label className="text-sm font-medium text-gray-700">Upload Story File</Label>
                <div 
              ...
              <div className="bg-yellow-50 p-4 border border-yellow-200">
                <h4 className="font-medium text-yellow-900 mb-2">Assessment Requirements:</h4>
        ...
        {usage && limits && (usage.stories >= limits.stories || usage.assessments >= limits.assessments) && (
          <Card className="max-w-2xl mx-auto mt-8 bg-blue-50 border-blue-200">
            <CardHeader>
              <CardTitle className="text-blue-900">Need More Stories?</CardTitle>
            </CardHeader>
            <CardContent>
