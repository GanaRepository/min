          ...
          >
            <div className="bg-white/10 backdrop-blur-xl border border-white/20  p-4 sm:p-6 shadow-2xl">
              ...
              <div className="relative mb-6  overflow-hidden">
                <div className="relative w-full h-56 sm:h-64 md:h-72 lg:h-80 bg-gradient-to-br from-purple-500 via-pink-600 to-orange-600  overflow-hidden">
            ...
            <div className="flex justify-center">
              <Link href="/login">
                <Button
                  variant="outline"
                  className="mb-6 bg-white/10 border-white/20 text-white hover:bg-gray-300 m-6 sm:m-8 md:m-10 flex justify-center"
                >
          ...
          >
            ...
            >
              <div className="space-y-1 sm:space-y-2">
                ...
                <div className="relative">
                  <input
                    ...
                    required
                    disabled={isLoading}
                    className="w-full px-3 sm:px-4 py-2 sm:py-3 rounded-lg bg-white/10 backdrop-blur-sm border border-white/20 text-white placeholder-white/60 focus:outline-none focus:ring-2 focus:ring-orange-400 focus:border-transparent transition-all text-xs sm:text-base cursor-text"
                  />
                </div>
              </div>
              ...
              <div className="space-y-1 sm:space-y-2">
                ...
                <div className="relative">
                  <input
                    ...
                    required
                    disabled={isLoading}
                    className="w-full px-3 sm:px-4 py-2 sm:py-3 pr-10 sm:pr-12 rounded-lg bg-white/10 backdrop-blur-sm border border-white/20 text-white placeholder-white/60 focus:outline-none focus:ring-2 focus:ring-orange-400 focus:border-transparent transition-all text-xs sm:text-base cursor-text"
                  />
                  <button
                    type="button"
                    className="absolute right-2 sm:right-3 top-1/2 transform -translate-y-1/2 text-white/60 hover:text-orange-300 transition-colors z-10 p-1"
                    onClick={(e) => {
                      e.preventDefault();
                      e.stopPropagation();
              ...
              <motion.button
                type="submit"
                disabled={isLoading}
                className="w-full bg-white hover:bg-orange-100 text-purple-900 py-3 sm:py-4 px-4 sm:px-6   transition-all duration-300 backdrop-blur-sm border border-white/30 disabled:opacity-50 disabled:cursor-not-allowed mt-4 sm:mt-6 text-xs sm:text-base"
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
              >
                {isLoading ? (
                  <div className="flex items-center justify-center">
                    <div className="w-5 h-5 border-2 border-purple-900/20 border-t-purple-900  animate-spin mr-2" />
