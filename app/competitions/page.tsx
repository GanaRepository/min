...
//           <h1 className="text-4xl  text-white mb-2 flex items-center justify-center gap-3 drop-shadow-lg">
...
//                           <div key={story._id} className="flex items-center justify-between bg-white/10  p-2">
//                             <div>
...
//                               className="bg-white/20 hover:bg-white/30 px-3 py-1  text-sm disabled:opacity-50"
//                             >
...
//             </ul>
//             <div className="bg-green-500/10 border border-green-500/20  p-2 text-green-300 text-xs">
...
//             </ul>
//             <div className="bg-blue-500/10 border border-blue-500/20  p-2 text-blue-300 text-xs mb-2">
...
//                   <div className="bg-purple-600/20 text-purple-400 px-2 py-1  text-xs font-medium">
//                     Completed
//                   </div>
//                 </div>
