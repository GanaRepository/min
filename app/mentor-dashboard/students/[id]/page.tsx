  ...
  return (
    <div className="space-y-4 sm:space-y-6 p-2 sm:p-4 md:p-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4">
        <Link href="/mentor-dashboard/students">
          <button className="text-gray-400 hover:text-white transition-colors text-xs sm:text-base">
            ← Back
          </button>
        </Link>
        <div>
      ...
      <div className="bg-gray-800 p-3 sm:p-6 flex flex-col sm:flex-row items-center gap-4 sm:gap-6">
        ...
        <div>
          ...
          <div className="flex flex-wrap items-center gap-2 sm:gap-3 mt-2 text-gray-400 text-[10px] sm:text-xs">
            ...
            <Calendar className="w-4 h-4 ml-2 sm:ml-4" /> Joined:{' '}
            {new Date(student.createdAt).toLocaleDateString()}
            {student.lastActiveAt && (
              <span>
                <span className="ml-2 sm:ml-4">Last Active:</span>{' '}
      ...
      <div className="bg-gray-800 p-3 sm:p-6">
        ...
        <div className="space-y-2 sm:space-y-3">
          {student.stories.length === 0 && (
            <p className="text-gray-400 text-xs sm:text-sm">No stories yet.</p>
          )}
