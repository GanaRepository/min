  ...
  return (
    <div className="space-y-6 px-2 sm:px-4 md:px-8 lg:px-12 xl:px-20 py-4 sm:py-6 md:py-8">
       ...
       >
         <div className="flex items-center justify-between mb-4">
           ...
           <div className="flex items-center">
             ...
             <span className={`ml-1 font-medium ${getGrowthColor(revenueData.growth)}`}>
     ...
     <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
         ...
         <div className="space-y-3">
           <Link href="/admin/revenue/transactions">
             <button className="w-full text-left p-3 bg-gray-700/50 rounded-lg hover:bg-gray-700 transition-colors">
               ...
               <p className="text-gray-400 text-sm mt-1">View all customer transactions</p>
             </button>
           </Link>
           ...
           <Link href="/admin/revenue/refunds">
             <button className="w-full text-left p-3 bg-gray-700/50 rounded-lg hover:bg-gray-700 transition-colors">
               <div className="flex items-center justify-between">
                 <span className="text-white font-medium">Refund Management</span>
                 <CreditCard size={16} className="text-orange-400" />
               </div>
               <p className="text-gray-400 text-sm mt-1">Process refund requests</p>
             </button>
           </Link>
         </div>
       </div>
         ...
         <div className="space-y-4">
           <div className="flex items-center justify-between p-3 bg-gray-700/50 rounded-lg">
             ...
             <span className="text-white font-medium">
               ${revenueData.totalRevenue > 0 && (revenueData.storyPacksSold + revenueData.publicationsSold) > 0
                 ? (revenueData.totalRevenue / (revenueData.storyPacksSold + revenueData.publicationsSold)).toFixed(2)
                 : '0.00'}
             </span>
           </div>
           ...
           <div className="flex items-center justify-between p-3 bg-gray-700/50 rounded-lg">
             ...
             <span className={`font-medium ${getGrowthColor(revenueData.growth)}`}>
               {revenueData.growth >= 0 ? '+' : ''}{revenueData.growth.toFixed(1)}%
             </span>
           </div>
         </div>
       ...
       <div className="bg-gray-800 rounded-xl p-6">
         <h3 className="text-lg font-semibold text-white mb-4">Top Paying Users</h3>
         <div className="space-y-3">
             ...
             <div key={user._id} className="flex items-center justify-between p-3 bg-gray-700/50 rounded-lg">
               <div className="flex items-center space-x-3">
                 ...
                 <div>
                   ...
                   <p className="text-gray-400 text-xs">{user.purchaseCount} purchases</p>
                 </div>
               </div>
