    ...
    <div className="space-y-6">
       ...
       <div className="bg-gray-800 rounded-xl p-6">
         ...
         <div className="space-y-4">
           <div className="flex justify-between items-center">
             ...
             <span className="text-white font-medium">{stats?.monthlyStats.newUsers || 0}</span>
           </div>
           <div className="flex justify-between items-center">
             <span className="text-gray-400">Stories Created</span>
             <span className="text-white font-medium">{stats?.monthlyStats.storiesCreated || 0}</span>
           </div>
           <div className="flex justify-between items-center">
             <span className="text-gray-400">Assessments</span>
             <span className="text-white font-medium">{stats?.monthlyStats.assessmentsCompleted || 0}</span>
           </div>
         </div>
       </div>
       ...
       <div className="bg-gray-800 rounded-xl p-6">
         ...
         <div className="space-y-4">
           <div className="flex justify-between items-center">
             ...
             <span className="text-blue-400 font-medium">{stats?.activeStories || 0}</span>
           </div>
           <div className="flex justify-between items-center">
             <span className="text-gray-400">Completed</span>
             <span className="text-green-400 font-medium">{stats?.completedStories || 0}</span>
           </div>
           <div className="flex justify-between items-center">
             <span className="text-gray-400">Total</span>
             <span className="text-white font-medium">{stats?.totalStories || 0}</span>
           </div>
         </div>
       </div>
     ...
     <div className="bg-gray-800 rounded-xl p-6">
       <div className="flex items-center justify-between mb-6">
         ...
         <Link href="/admin/activity" className="text-blue-400 hover:text-blue-300 text-sm">
           View All
         </Link>
       </div>
...
function getActivityColor(type: string) {
 switch (type) {
   ...
   case 'assessment_completed': return 'bg-orange-500';
