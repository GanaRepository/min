  ...
  if (!user) {
    return (
      <div className="text-center py-12">
        ...
        <h3 className="text-xl font-medium text-gray-400 mb-2">User not found</h3>
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center space-x-4">
        ...
        <div>
          ...
          <p className="text-gray-400">Manage user information and activities</p>
        </div>
      </div>
          ...
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <div className="flex items-center space-x-2 mt-2">
                ...
                <span className={`px-2 py-1 rounded-full text-xs border ${user.isVerified ? 'bg-green-500/20 text-green-300 border-green-500/30' : 'bg-red-500/20 text-red-300 border-red-500/30'}`}>
        ...
        <div className="bg-gray-800 rounded-xl p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-white">{user.totalStories}</p>
            </div>
        ...
        <div className="bg-gray-800 rounded-xl p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-white">{user.completedStories}</p>
            </div>
        ...
        <div className="bg-gray-800 rounded-xl p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-white">{user.activeStories}</p>
            </div>
