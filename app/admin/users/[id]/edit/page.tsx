  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center h-64">
        <div className="text-xl text-gray-400">Loading user data...</div>
      </div>
    );
  }
    ...
    <div className="space-y-6 px-2 sm:px-4 md:px-8 lg:px-12 xl:px-20 py-4 sm:py-6 md:py-8">
      ...
      >
        <form onSubmit={handleSubmit} className="space-y-6">
         ...
         {formData.role === 'child' && (
           <div>
             <h3 className="text-lg font-semibold text-white mb-4">Monthly Usage Overrides</h3>
             <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
               <div>
                 ...
                 <input
                   ...
                   onChange={(e) => handleInputChange('storiesCreatedThisMonth', parseInt(e.target.value) || 0)}
               ...
               <div>
                 ...
                 <input
                   ...
                   onChange={(e) => handleInputChange('assessmentUploadsThisMonth', parseInt(e.target.value) || 0)}
                   className="w-full px-4 py-3 bg-gray-700 border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500"
                 />
                 <p className="text-gray-400 text-xs mt-1">Default limit: 3</p>
               </div>
               ...
               <div>
                 ...
                 <input
                   ...
                   onChange={(e) => handleInputChange('competitionEntriesThisMonth', parseInt(e.target.value) || 0)}
                   className="w-full px-4 py-3 bg-gray-700 border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500"
                 />
                 <p className="text-gray-400 text-xs mt-1">Default limit: 3</p>
               </div>
             ...
             <div className="bg-yellow-900/20 border border-yellow-500/30 rounded-lg p-3 mt-4">
               <p className="text-yellow-300 text-sm">
                 ⚠️ These overrides allow you to manually adjust a user's monthly usage counters. 
                 Use this feature carefully as it affects their limits and billing.
               </p>
             </div>
           </div>
         )}
