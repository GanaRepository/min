...
export interface IAchievement extends Document {
  ...
  // Achievement details
  achievementType: 'writing' | 'creativity' | 'competition' | 'milestone' | 'consistency' | 'improvement';
  title: string;
  description: string;
  icon: string;
  color: string;
  ...
  criteria: {
    triggerType: 'story_count' | 'word_count' | 'score_threshold' | 'competition_rank' | 'streak' | 'improvement';
    threshold?: number;
...
const AchievementSchema = new Schema<IAchievement>({
  ...
  achievementType: {
    type: String,
    enum: ['writing', 'creativity', 'competition', 'milestone', 'consistency', 'improvement'],
    required: true,
  },
  title: {
    type: String,
  ...
  criteria: {
    triggerType: {
      type: String,
      enum: ['story_count', 'word_count', 'score_threshold', 'competition_rank', 'streak', 'improvement'],
      required: true,
    },
