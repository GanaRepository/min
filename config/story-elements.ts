...
export const STORY_ELEMENTS = {
  genre: [
    ...
    },
    {
      name: 'Mystery',
      emoji: '🔍',
      description: 'Puzzles and secrets to solve',
    },
    {
    ...
    { name: 'Horror', emoji: '👻', description: 'Spooky and thrilling tales' },
    {
      name: 'Romance',
      emoji: '💕',
      description: 'Love and heartwarming relationships',
    },
    { name: 'Historical', emoji: '📜', description: 'Stories from the past' },
    {
      name: 'Western',
      emoji: '🤠',
      description: 'Cowboys and frontier adventures',
    },
    {
      name: 'Superhero',
      emoji: '🦸',
    ...
    { name: 'Thriller', emoji: '⚡', description: 'Heart-pounding suspense' },
    {
      name: 'Drama',
      emoji: '🎭',
      description: 'Emotional and meaningful stories',
    },
    {
      name: 'Sports',
      emoji: '⚽',
    ...
    },
    {
      name: 'Musical',
      emoji: '🎵',
      description: 'Stories filled with song and dance',
    },
  ],
  character: [
    {
      name: 'Brave Knight',
      emoji: '⚔️',
      description: 'Noble warrior with honor',
    },
    {
      name: 'Clever Detective',
      emoji: '🕵️',
    ...
    },
    {
      name: 'Young Wizard',
      emoji: '🧙',
      description: 'Learning magical powers',
    },
    {
      name: 'Space Explorer',
      emoji: '👨‍🚀',
      description: 'Adventurer among the stars',
    },
    {
      name: 'Animal Friend',
      emoji: '🐺',
      description: 'Companion of creatures',
    },
    {
      name: 'Pirate Captain',
      emoji: '🏴‍☠️',
    ...
    { name: 'Forest Ranger', emoji: '🌳', description: 'Protector of nature' },
    {
      name: 'Time Traveler',
      emoji: '⏰',
      description: 'Journeyer through time',
    },
    {
      name: 'Dragon Tamer',
      emoji: '🐲',
      description: 'Befriender of mighty beasts',
    },
    ...
    { name: 'Sky Pilot', emoji: '✈️', description: 'Master of the airways' },
    {
      ...
      emoji: '🧗',
      description: 'Conqueror of peaks',
    },
    {
      name: 'Inventor Genius',
      emoji: '🔬',
      description: 'Creator of amazing devices',
    },
  ...
  setting: [
    ...
    },
    {
      name: 'Ancient Castle',
      emoji: '🏰',
      description: 'Mysterious old fortress',
    },
    { name: 'Busy City', emoji: '🏙️', description: 'Modern urban environment' },
    {
      name: 'Space Station',
      emoji: '🛰️',
      description: 'Floating home among stars',
    },
    {
      name: 'Underwater Kingdom',
      emoji: '🌊',
      description: 'Realm beneath the waves',
    },
    {
      name: 'Desert Oasis',
      emoji: '🏜️',
      description: 'Hidden paradise in the sand',
    },
    {
      name: 'Floating Island',
      emoji: '☁️',
      description: 'Magical island in the sky',
    },
    {
      name: 'Haunted Mansion',
      emoji: '🏚️',
      description: 'Spooky old house with secrets',
    },
    {
      name: 'Pirate Ship',
      emoji: '⛵',
      description: 'Vessel sailing the seven seas',
    },
    {
      name: 'Secret Laboratory',
      emoji: '⚗️',
      description: 'Hidden place of experiments',
    },
    {
      name: 'Jungle Temple',
      emoji: '🗿',
      description: 'Ancient ruins in the wilderness',
    },
    {
      name: 'Ice Palace',
      emoji: '🧊',
      description: 'Crystalline fortress of frost',
    },
    {
      name: 'Carnival Grounds',
      emoji: '🎪',
      description: 'Colorful world of entertainment',
    },
    {
      name: 'Mountain Peak',
      emoji: '⛰️',
      description: 'Towering summit touching the sky',
    },
    {
      name: 'Magic School',
      emoji: '🎓',
      description: 'Academy for learning spells',
    },
  ],
  theme: [
    {
      name: 'Friendship',
      emoji: '🤝',
      description: 'The power of companionship',
    },
    { name: 'Courage', emoji: '💪', description: 'Being brave when scared' },
    { name: 'Discovery', emoji: '🔭', description: 'Finding something new' },
    { name: 'Family', emoji: '👨‍👩‍👧‍👦', description: 'Love and belonging' },
    ...
    { name: 'Justice', emoji: '⚖️', description: 'Fighting for what is right' },
    {
      name: 'Perseverance',
      emoji: '🏃',
      description: 'Never giving up on dreams',
    },
    {
      name: 'Kindness',
      emoji: '❤️',
    ...
    },
    {
      name: 'Self-Belief',
      emoji: '🌟',
      description: 'Having confidence in yourself',
    },
  ],
  mood: [
    { name: 'Exciting', emoji: '🎢', description: 'Fast-paced and thrilling' },
    ...
    { name: 'Peaceful', emoji: '🌺', description: 'Calm and serene' },
    {
      name: 'Energetic',
      emoji: '⚡',
      description: 'Full of action and movement',
    },
    ...
    { name: 'Cozy', emoji: '🏠', description: 'Warm and comfortable' },
    {
      name: 'Dynamic',
      emoji: '🌪️',
      description: 'Constantly changing and moving',
    },
    {
      name: 'Inspiring',
      emoji: '🌈',
  ...
  tone: [
    ...
    },
    {
      name: 'Mysterious',
      emoji: '🔮',
      description: 'Secretive and intriguing',
    },
    ...
    { name: 'Fierce', emoji: '🔥', description: 'Intense and powerful' },
    {
      name: 'Compassionate',
      emoji: '🤗',
      description: 'Understanding and empathetic',
    },
